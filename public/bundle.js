...
var IndecitionsApp = function (_React$Component) {
    _inherits(IndecitionsApp, _React$Component);

    function IndecitionsApp(props) {
        _classCallCheck(this, IndecitionsApp);

        var _this = _possibleConstructorReturn(this, (IndecitionsApp.__proto__ || Object.getPrototypeOf(IndecitionsApp)).call(this, props));
...
Header.defaultProps = {
    title: "This is someThing Default"
};
...
_reactDom2.default.render(_react2.default.createElement(IndecitionsApp, { options: ["Devil den", "The next district"] }), document.getElementById('app'));
